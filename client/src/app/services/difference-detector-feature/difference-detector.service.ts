...
export class DifferenceDetectorService {
  ...
  setOffSet(offsetGiven: number){
    this.offset = offsetGiven 
  }

  setImageDataToCompare(imageDatasToCompareGiven: ImageDataToCompare){
    this.imageDatasToCompare = imageDatasToCompareGiven;
