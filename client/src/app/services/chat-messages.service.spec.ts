...
import { DEFAULT_USERNAME, MESSAGE_ERROR_DIFFERENCE_SOLO, NO_DIFFERENCE_FOUND_ARRAY } from '@common/const';
...
describe('ChatMessagesService', () => {
    ...
    //     socketTestHelper.peerSideEmit('Valid click', notValidClickInfo);
    //     await setTimeout(() => {
    //         expect(messageReceivedFromObservable.message.includes(MESSAGE_ERROR_DIFFERENCE_MULTI)).toBeTrue();
    //     }, littleTimeout);
    // });
    ...
    //     socketTestHelper.peerSideEmit('Valid click', differencesFoundInfo);
    //     await setTimeout(() => {
    //         expect(messageReceivedFromObservable.message.includes(MESSAGE_DIFFERENCE_FOUND_MULTI)).toBeFalse();
    //     }, littleTimeout);
    // });
    ...
    //     await setTimeout(() => {
    //         expect(messageReceivedFromObservable.message.includes(messageFromPlayer.message)).toBeFalse();
    //     }, littleTimeout);
    // });
    ...
    //     await setTimeout(() => {
    //         expect(messageReceivedFromObservable.message.includes(ABANDON_MESSAGE)).toBeFalse();
    //     }, littleTimeout);
    // });
