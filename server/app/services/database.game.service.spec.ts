...
describe("Games service", () => {
  let gamesService: RecordTimesService;
  let databaseService: DatabaseServiceMock;
  let client: MongoClient;
  let testGame: GameTimes;
  ...
  beforeEach(async () => {
    ...
    gamesService = new RecordTimesService(databaseService as any);
    testTimes = {soloGameTimes: [(new RecordTime('00:00', 'playerUsername'))], multiplayerGameTimes:[(new RecordTime('00:00', 'playerUsername'))]};
    testTimeOne = {
        minutes: 0,
        seconds: 59,
    };
